...
You can utilize functions in zoo package in `cal_factory_zoo`. Here, for example, I utilize `zoo::rollmean`, and manufacture `tq_rollmean`, which has the same functionality of `tq_ma`.
